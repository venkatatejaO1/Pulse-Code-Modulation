# Pulse Code Modulation and DM

## Aim
To perform Pulse Code Modulation (PCM) and DM on an analog signal and visualize the message signal, clock signal, quantized signal, and demodulated signal.
...
## Output Waveform
- Plot of the original message signal (analog signal).
...
## Results
The Pulse Code Modulation (PCM) and DELTA MODULATION(DM) process was successfully performed on an analog signal. The quantized signal closely follows the original message signal, demonstrating effective PCM AND DM encoding and visualization.
